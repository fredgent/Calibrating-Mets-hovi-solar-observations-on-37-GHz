...
\subsection{Data sources}\label{sect:source}
  ...
  %Omit plot titles, these can be described in the captions. 
  ...
  Does the text below apply to this method?}
...
%\caption{Closeup of Fig.~\ref{carrington1} showing details of individual tracks. Migration during the given time interval is represented with arrows.}
%\label{carrington2}
%\end{figure}
%
%
...
%\caption{Closeup of Fig.~\ref{carrington1} showing details of individual observation times with color.}
%\label{carrington3}
%\end{figure}
%
