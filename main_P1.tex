...
\eqnl{relative_radec}{
  ...
  determine the center of the visual disk from each map, from which we
  define the relative location of each sample.
  Also, since the signal levels $u_i$ have arbitrary scale, 
  they need to be normalized.
  A solar map contains the regions designated as
  \begin{itemize}
