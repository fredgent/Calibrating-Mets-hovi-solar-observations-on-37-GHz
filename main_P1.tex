...
based on manually collected values has been made, such as \cite{KLJU12,VR12} and \cite{VSV87}. For the first time, 
...
Cycle 21 maps have previously been analysed with manual methods in \cite{KLJU12,VR12} using undigitised maps. The calibration process has been developed further.
