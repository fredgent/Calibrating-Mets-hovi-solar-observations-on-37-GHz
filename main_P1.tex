...
%MJK better to be clearer: cycle -> sunspot cycle; also, maybe to explain further, that the amount of sunspots and active regions reaches a maximum during each half-cycle.
  ...
  in 1904.
  Since sunspots are a feature of Sun's magnetic field, similar butterfly 
  diagrams are also recovered from solar magnetograms \citep{GHHZ83}.
  It is also reported for radio brightenings of the $\SI{37}{GHz}$ band
  inc \citet{Shibasaki13,metsahovi40}.
...
%MJK Adding label
\subsection{Disk fitting and signal levels} \label{Sect:DiskFitting}Limb intensity profiles showing brightening. 
